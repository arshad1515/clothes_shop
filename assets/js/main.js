...
(function($) {
    ...
    Ali.ElementsSpacingClasses = function() {
    ...
    Ali.testimonialCarousel = function() {
    ...
    Ali.interactiveBehaviour = function() {
    ...
    Ali.instagramSettings = function() {
    ...
    $document.on('ready', function() {
        Ali.niceInit(),
            Ali.mainNav(),
            Ali.elementsCarousel(),
            Ali.galleryWithThumb(),
            Ali.testimonialCarousel(),
            Ali.scrollToTop(),
            Ali.toolTips(),
            Ali.mcSettings(),
            Ali.instagramSettings();
    });

    // Window load and resize functions
    $window.on('load resize', function() {
        Ali.ElementsSpacingClasses();
    });
